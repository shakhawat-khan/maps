...
class SearchMapPlaceWidget1 extends StatefulWidget {
  const SearchMapPlaceWidget1({
  ...
  @override
  _SearchMapPlaceWidgetState1 createState() => _SearchMapPlaceWidgetState1();
}

class _SearchMapPlaceWidgetState1 extends State<SearchMapPlaceWidget1>
